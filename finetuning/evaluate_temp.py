...
# Models to evaluate
to_eval = [
    "dinov2_vitb14_finetuned_only_model_10temp.pth",
...
for model_name in to_eval:
    ...
    model_short_name = model_name.replace("vitb14_finetuned_only_model_", "").replace(".pth", "")
    results_dir = f'results/validation_{model_short_name}_{timestamp}'
    ...
    model_path = f"../models/dinov2/{model_name}"
...
comparison_file = f'results/validation_comparison_{timestamp}.json'
